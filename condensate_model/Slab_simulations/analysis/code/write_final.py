# Function to write a .gro file (final.gro) of the last frame of a simulation, centered at the largest cluster.
# Written by Andrew Latham
# Note the inputs at top. These need to be customized for the system.
# Here, we assume 100 molecules, with 4999 equilibration frames (5000 total frames), and a minimum distance cutoff of 10 Ang
...
def contact_mat(dcd_file,pdb_file,mass_xml,npt_xml,nchain,start,cutoff):
    ...
    for ts in u1.trajectory:
        if ts.frame < start:
            ...
            for i in range(0,N):
                ...
                # reset the Z-coordinate after wrapping
    ...
    # write Z_pos, for debugging
    #numpy.savetxt('Z_pos.txt',Z_pos)
