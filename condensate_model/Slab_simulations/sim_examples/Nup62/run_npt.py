...
FG_parser = MOFFParser.from_atomistic_pdb('Nup62_IDR_AF.pdb', 'Nup62_IDR_CA.pdb')

# Nup62 has no ordered domains- pass empty native pairs
...
box_b=100
box_c=100
insert_molecules('Nup62_IDR_CA.pdb', 'start.pdb', n_mol, box=[box_a, box_b, box_c])
...
# save final system
condensate.save_system('Nup62_IDR_system.xml')
