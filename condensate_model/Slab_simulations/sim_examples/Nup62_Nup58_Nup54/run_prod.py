...
system_xml = 'Nup62_Nup58_Nup54.xml'
with open(system_xml, 'r') as f:
    system = mm.XmlSerializer.deserialize(f.read())
#system.addForce(mm.MonteCarloMembraneBarostat(0*bar, 0*bar*nanometer, MonteCarloMembraneBarostat.XYIsotropic, MonteCarloMembraneBarostat.ZFree, 300*kelvin))
...
simulation.reporters.append(StateDataReporter('prod.csv', int(dt/1000), step=True, time=True, potentialEnergy=True, temperature=True, volume=True, density=True, speed=True, pressure=True,pxx=True,pyy=True,pzz=True))
