...
FG_parser = MOFFParser.from_atomistic_pdb('Nup214_NT_AF.pdb', 'Nup214_NT_CA.pdb')
...
for i, row in old_native_pairs.iterrows():
    ...
    if a1 > a2:
        a1, a2 = a2, a1
    flag10=( (a1 in OD1) and (a2 in OD1) )
    if flag10:
...
box_b=100
box_c=100
insert_molecules('Nup214_NT_CA.pdb', 'start.pdb', n_mol, box=[box_a, box_b, box_c])
...
# save final system
condensate.save_system('Nup214_NT_system.xml')
