...
Nup_parser = MOFFParser.from_atomistic_pdb('N98_AF.pdb', 'N98_CA.pdb')
...
# setup initial topology
top = app.PDBFile('N98_CA.pdb').getTopology()
...
# save initial system
protein.save_system('N98_system.xml')
# setup integrator
friction_coeff = 1/unit.picosecond
timestep = 10*unit.femtosecond
integrator = mm.LangevinMiddleIntegrator(temperature, friction_coeff, timestep)
# setup initial coordinates
init_coord = app.PDBFile('N98_CA.pdb').getPositions()
# setup simulation
