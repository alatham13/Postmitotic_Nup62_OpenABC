...
Nup_parser = MOFFParser.from_atomistic_pdb('N49_AF.pdb', 'N49_CA.pdb')
...
# setup initial topology
top = app.PDBFile('N49_CA.pdb').getTopology()
...
# save initial system
protein.save_system('N49_system.xml')
# setup integrator
friction_coeff = 1/unit.picosecond
timestep = 10*unit.femtosecond
integrator = mm.LangevinMiddleIntegrator(temperature, friction_coeff, timestep)
# setup initial coordinates
init_coord = app.PDBFile('N49_CA.pdb').getPositions()
# setup simulation
