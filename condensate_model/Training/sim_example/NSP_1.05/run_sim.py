...
Nup_parser = MOFFParser.from_atomistic_pdb('NSP_AF.pdb', 'NSP_CA.pdb')
...
# setup initial topology
top = app.PDBFile('NSP_CA.pdb').getTopology()
...
# save initial system
protein.save_system('NSP_system.xml')
# setup integrator
friction_coeff = 1/unit.picosecond
timestep = 10*unit.femtosecond
integrator = mm.LangevinMiddleIntegrator(temperature, friction_coeff, timestep)
# setup initial coordinates
init_coord = app.PDBFile('NSP_CA.pdb').getPositions()
# setup simulation
