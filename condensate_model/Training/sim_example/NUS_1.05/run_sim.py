...
Nup_parser = MOFFParser.from_atomistic_pdb('NUS_AF.pdb', 'NUS_CA.pdb')
...
# setup initial topology
top = app.PDBFile('NUS_CA.pdb').getTopology()
...
# save initial system
protein.save_system('NUS_system.xml')
# setup integrator
friction_coeff = 1/unit.picosecond
timestep = 10*unit.femtosecond
integrator = mm.LangevinMiddleIntegrator(temperature, friction_coeff, timestep)
# setup initial coordinates
init_coord = app.PDBFile('NUS_CA.pdb').getPositions()
# setup simulation
